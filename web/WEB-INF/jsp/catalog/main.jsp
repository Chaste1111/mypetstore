...
<div id="Welcome">
  <div id="WelcomeContent">
    ...
    <%
      // 从Session中获取登录用户信息
      csu.web.mypetstore.domain.Account account = (csu.web.mypetstore.domain.Account)session.getAttribute("account");
      if (account != null) {
    %>
    Welcome, <%= account.getFirstName() %>!
    <p>
      <a href="${pageContext.request.contextPath}/updateAccount">Update Profile</a> |
      <a href="${pageContext.request.contextPath}/signOff">Sign Out</a>
    </p>
    <% } %>
  </div>
</div>
